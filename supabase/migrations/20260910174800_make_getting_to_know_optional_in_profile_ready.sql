-- Align compute_candidate_profile_ready() with CandidateAdditional.tsx:
-- "Daj się poznać" (getting_to_know) is optional and must not gate additional_completed.
-- No bulk recompute here — existing rows keep current flags until their next update.
