...
interface ReqBody {
  ...
  message?: string;
  /** "auto" when sent automatically after employer marked the candidate as interested, "manual" otherwise. */
  trigger?: "auto" | "manual";
}
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const { candidate_user_id, match_id, employer_company_name, message, trigger } = body;
