        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h3 className="font-semibold text-lg sm:text-xl text-foreground">
              {t("employer.candidates.candidateNumber")} #{match.candidate_user_id ? match.candidate_user_id.slice(0, 8) : "---"}
            </h3>
          ...
          <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-2 shrink-0">
            ...
            <Link
  to={`/employer/candidate/${match.candidate_user_id || ""}?matchId=${encodeURIComponent(
    match.id,
  )}&offerId=${encodeURIComponent(match.job_offer_id || "")}`}
>
